...
#define THREAD_CPU_CONTEXT 6752 /* offsetof(struct task_struct, thread.cpu_context) */
#define THREAD_SCTLR_USER 7840 /* offsetof(struct task_struct, thread.sctlr_user) */
#define THREAD_KEYS_USER 7736 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 7816 /* offsetof(struct task_struct, thread.keys_kernel) */
#define THREAD_MTE_CTRL 7832 /* offsetof(struct task_struct, thread.mte_ctrl) */
...
#define MM_CONTEXT_ID 992 /* offsetof(struct mm_struct, context.id.counter) */
